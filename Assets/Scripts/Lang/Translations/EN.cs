...
public static class EN
{
    ...
    static EN()
    {
        ...
        lang.Add("GeneralVolumeText", "General Volume");
        lang.Add("EffectsVolumeText", "Effects");
        lang.Add("MusicVolumeText", "Music");
        lang.Add("PlayerVolumeText", "Player");
        lang.Add("EnemiesVolumeText", "Enemies");
        lang.Add("UIVolumeText", "User Interface");
        ...
        lang.Add("JumpText", "Jump");
        lang.Add("RightText", "Right");
        lang.Add("LeftText", "Left");
        lang.Add("DownText", "Down");
        lang.Add("AttackText", "Attack");
        lang.Add("SpecialText", "Use Special");
        lang.Add("ChangeSpecialText", "Change Ability");
        lang.Add("JumpButton", "Left Stick Up");
        lang.Add("RightButton", "Left Stick Right");
        lang.Add("LeftButton", "Left Stick Left");
        lang.Add("DownButton", "Left Stick Down");
